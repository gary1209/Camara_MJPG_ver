var ADDR_IP_CAM = "140.113.237.219";
var PORT_IP_CAM_API = "8080";
var PORT_IP_CAM_RTSP = "554";
var UNAME_IP_CAM = "iottalk";
var UWORD_IP_CAM = "iottalk2019";
var ENABLE_AUTH_IP_CAM = 1; //1: TRUE, 0: FALSE
var ADDR_KURENTO_SERVER = "hi1.iottalk.tw";  // CHT VM
var PORT_KURENTO_SERVER = "8433"; // WSS WebSocket Secure
var ADDR_REMOTE_CONTROL = "https://garden2.iottalk.tw/rc/";  // MIRC311 Remote Control
var ADDR_REMOTE_CONTROL2 = "http://garden.iottalk.tw/da/Remote_control/";   
function CamControl(movetype, direction)
{
			...
			else if (movetype == "zoom")
			{
				...
				try {
					...
					//parent.retframe.location.href='http://' + ADDR_IP_CAM + ':' + PORT_IP_CAM_API + '/cgi-bin/camctrl/camctrl.cgi?' + joystickcmd;
                                        parent.retframe.location.href='http://' + ADDR_IP_CAM + ':' + PORT_IP_CAM_API + '/cgi-bin/camctrl/eCamCtrl.cgi?channel=0&stream=0&' + joystickcmd;  //ePTZ
				}
				catch (err) {
					//retframe.location.href='http://140.113.169.231/cgi-bin/camctrl/camctrl.cgi?' + joystickcmd + "&stream=" + streamsource;
					//retframe.location.href='http://' + ADDR_IP_CAM + ':' + PORT_IP_CAM_API + '/cgi-bin/camctrl/camctrl.cgi?' + joystickcmd;
                                        retframe.location.href='http://' + ADDR_IP_CAM + ':' + PORT_IP_CAM_API + '/cgi-bin/camctrl/eCamCtrl.cgi?channel=0&stream=0&' + joystickcmd;  //ePTZ
				}
			}
...
window.addEventListener('load', function(){
	if(ENABLE_AUTH_IP_CAM == 1) {
		document.getElementById("address").value="rtsp://" + UNAME_IP_CAM + ":" + UWORD_IP_CAM + "@" + ADDR_IP_CAM + ":" + PORT_IP_CAM_RTSP + "/live.sdp";
	} else {
		document.getElementById("address").value="rtsp://" + ADDR_IP_CAM + ":" + PORT_IP_CAM_RTSP + "/live3.sdp";
	}
